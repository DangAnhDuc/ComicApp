...
public class MyComicAdapter extends RecyclerView.Adapter<MyComicAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.setRecyclerItemClickListener(new IRecyclerItemClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                context.startActivity(new Intent(context, ChapterActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
            }
        });
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            comic_image=(ImageView) itemView.findViewById(R.id.image_comics);
